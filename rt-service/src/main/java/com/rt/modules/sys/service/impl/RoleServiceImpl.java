...
import com.rt.modules.sys.vo.query.RoleQueryVO;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    private  void grant(Long id,List<Long> resourceIds) {
        roleResourceMapper.delete(new QueryWrapper<RoleResource>().eq("role_id",id));
        if(CollectionUtils.isNotEmpty(resourceIds)){
            for(Long roleId:resourceIds){
                roleResourceMapper.insert(new RoleResource(id,roleId));
            }
        }
    }
}
